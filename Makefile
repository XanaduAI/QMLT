...
help:
	...
	@echo "  install            to install QML Toolbox"
	@echo "  wheel              to build the QML Toolbox wheel"
...
install:
ifndef PYTHON3
	@echo "To install QML Toolbox you need to have Python 3 installed"
endif
...
test:
	$(PYTHON) $(TESTRUNNER)
	rm -rf logsAUTO logsNUM newpath
